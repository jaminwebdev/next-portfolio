          ...
          <div className="flex gap-0">
            {icons.map((icon, index) => (
              <a
                ...
                key={icon}
                className="p-2 rounded-full border-[3px] border-primary-medium dark:border-secondary dark:bg-body-color-dark grid place-content-center hover:scale-110 transition-all ease duration-200">
                <img
                  className="w-6"
